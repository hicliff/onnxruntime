...
#define SPECIALIZED_BINARY_ELEMENTWISE_IMPL_UINT(name) \
  SPECIALIZED_BINARY_ELEMENTWISE_IMPL(name, uint32_t)                    \
  SPECIALIZED_BINARY_ELEMENTWISE_IMPL(name, uint64_t)                    \
  SPECIALIZED_BINARY_ELEMENTWISE_IMPL(name, uint16_t)                    \
  SPECIALIZED_BINARY_ELEMENTWISE_IMPL(name, uint8_t)

#define SPECIALIZED_BINARY_ELEMENTWISE_IMPL_INTEGRAL(name) \
  SPECIALIZED_BINARY_ELEMENTWISE_IMPL(name, uint32_t)              \
  SPECIALIZED_BINARY_ELEMENTWISE_IMPL(name, uint64_t)              \
  SPECIALIZED_BINARY_ELEMENTWISE_IMPL(name, uint16_t)              \
  SPECIALIZED_BINARY_ELEMENTWISE_IMPL(name, uint8_t)               \
  SPECIALIZED_BINARY_ELEMENTWISE_IMPL(name, int32_t)               \
  SPECIALIZED_BINARY_ELEMENTWISE_IMPL(name, int64_t)               \
  SPECIALIZED_BINARY_ELEMENTWISE_IMPL(name, int16_t)               \
  SPECIALIZED_BINARY_ELEMENTWISE_IMPL(name, int8_t)
...
SPECIALIZED_BINARY_ELEMENTWISE_IMPL_INTEGRAL(BitwiseAnd)
SPECIALIZED_BINARY_ELEMENTWISE_IMPL_INTEGRAL(BitwiseOr)
SPECIALIZED_BINARY_ELEMENTWISE_IMPL_INTEGRAL(BitwiseXor)
SPECIALIZED_BINARY_ELEMENTWISE_IMPL_UINT(BitShiftRight)
SPECIALIZED_BINARY_ELEMENTWISE_IMPL_UINT(BitShiftLeft)
